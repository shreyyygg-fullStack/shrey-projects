...
import { DetailDialogDataSet, IndFilterCountA, IndFilterCountB } from '../shared/services/indentdb.type';
...
export class DashboardComponent implements OnInit {
  ...
  constructor(private httpcon: HttpClient, private cservice: CommonServiceService, private datePipe: DatePipe, private router: Router, private ngxService: NgxUiLoaderService) { }

  ngOnInit() {
     this.initSignalDataFromServer();
  }
 ...
 initSignalDataFromServer() {

  this.ngxService.start();
  
    const urllink1 = GlobalConstants.apiFilter_AllCount;
    const urllink2 = GlobalConstants.apiFilter_AllYellowCount;
    this.barChartData = [];

    this.httpcon.get<IndFilterCountA[]>(GlobalConstants.apiFilter_AllCount)
    .subscribe(Response => {
        this.filtcount = [];
        this.filtcount = Response;
        this.barChartData.push({
          data: [
            Number(this.filtcount['snfSignal']),
            Number(this.filtcount['apSignal']),
            Number(this.filtcount['lcSignal']),
            Number(this.filtcount['bpSignal']),
            Number(this.filtcount['outSignal']),
            Number(this.filtcount['pnsSignal']),
            Number(this.filtcount['lcpSignal']),
            Number(this.filtcount['pexfpSignal']),
            Number(this.filtcount['fexfpSignal']),
            Number(this.filtcount['sspSignal']),
            Number(this.filtcount['sapSignal']),
          ],label : 'Blue Signal'
        })
        this.blErrorChk = true;
        this.httpcon.get<IndFilterCountB[]>(GlobalConstants.apiFilter_AllYellowCount)
        .subscribe(Response2 => {
            this.filtYellocount = [];
            this.filtYellocount = Response2;
          this.barChartData.push({
            data: [
              Number(this.filtYellocount['snfSignal']),
              Number(this.filtYellocount['apSignal']),
              Number(this.filtYellocount['lcSignal']),
              Number(this.filtYellocount['bpSignal']),
              Number(this.filtYellocount['outSignal']),
              Number(this.filtYellocount['pnsSignal']),
              Number(this.filtYellocount['lcpSignal']),
              Number(this.filtYellocount['pexfpSignal']),
              Number(this.filtYellocount['fexfpSignal']),
              Number(this.filtYellocount['sspSignal']),
              Number(this.filtYellocount['sapSignal']),
            ],label : 'Yellow Signal'
          });
          this.ysErrorChk = true;
          this.chartFlag = true;
        });
    });
  ...
  snfSignalInit() {
    if (this.globalFlagColl === true) {
      this.snfDownFlag = true;
      this.indents = [];
      this.selectTypExpandNum = 0;
      this.titleFgFlag2 = true;
      this.collapseExpandFlag = false;
      this.showistCardFlag();
      this.indentAllFormDetail = false;
      this.hideDetailFlag();
      this.chartFlag = true;
      this.globalFlagColl = false;
    } else {
      if (this.blErrorChk === true && this.ysErrorChk === true) {
         this.collapseExpandFlag = true;
        this.snfDownFlag = false;
        this.indents = [];
        this.selectTypExpandNum = 1;
        this.ipFilTitleText = 'Blue Signal Count';
        this.titleFgFlag2 = false;
        this.globalFlagColl = true;
        this.hideListCardFlag();
        this.snfDropDwFlag = true;
        this.selectInfoCount = this.filtcount['snfSignal'];
        this.ysBackEvntSNF();
      }
    }
  ...
  apSignalInit() {
    if (this.globalFlagColl === true) {
      ...
      if (this.blErrorChk === true && this.ysErrorChk === true) {
        this.collapseExpandFlag = true;
        this.apDownFlag = false;
        this.indents = [];
        this.selectTypExpandNum = 2;
        this.ipFilTitleText = 'Blue Signal Count';
        this.titleFgFlag2 = false;
        this.globalFlagColl = true;
        this.hideListCardFlag();
        this.apDropDwFlag = true;
        this.selectInfoCount = this.filtcount['apSignal'];
        this.ysBackEvntAP();
      }
    }
  ...
  lpSignalInit() {
    if (this.globalFlagColl === true) {
      ...
      if (this.blErrorChk === true && this.ysErrorChk === true) {
        this.collapseExpandFlag = true;
        this.lcpDownFlag = false;
        this.indents = [];
        this.selectTypExpandNum = 3;
        this.ipFilTitleText = 'Blue Signal Count';
        this.titleFgFlag2 = false;
        this.globalFlagColl = true;
        this.hideListCardFlag();
        this.lpDropDwFlag = true;
        this.selectInfoCount = this.filtcount['lcSignal'];
        this.ysBackEvntLP();
  ...
  bpSignalInit() {
    if (this.globalFlagColl === true) {
      ...
      if (this.blErrorChk === true && this.ysErrorChk === true) {
        this.collapseExpandFlag = true;
        this.bspDownFlag = false;
        this.indents = [];
        this.selectTypExpandNum = 4;
        this.ipFilTitleText = 'Blue Signal Count';
        this.titleFgFlag2 = false;
        this.globalFlagColl = true;
        this.hideListCardFlag();
        this.bpDropDwFlag = true;
        this.selectInfoCount = this.filtcount['bpSignal'];
        this.ysBackEvntBP();
  ...
  outSignalInit() {
    if (this.globalFlagColl === true) {
      ...
      if (this.blErrorChk === true && this.ysErrorChk === true) {
        this.collapseExpandFlag = true;
        this.otDownFlag = false;
        this.indents = [];
        this.selectTypExpandNum = 5;
        this.ipFilTitleText = 'Blue Signal Count';
        this.titleFgFlag2 = false;
        this.globalFlagColl = true;
        this.hideListCardFlag();
        this.outDropDwFlag = true;
        this.selectInfoCount = this.filtcount['outSignal'];
        this.ysBackEvntOUT();
  ...
  pnsSignalInit() {
    if (this.globalFlagColl === true) {
      this.pnsDownFlag = true;
      this.indents = [];
      this.selectTypExpandNum = 0;
      this.titleFgFlag1 = true;
      this.collapseExpandFlag = false;
      this.globalFlagColl = false;
      this.showistCardFlag();
      this.indentAllFormDetail = false;
      ...
      if (this.blErrorChk === true && this.ysErrorChk === true) {
        this.collapseExpandFlag = true;
        this.pnsDownFlag = false;
        this.indents = [];
        this.selectTypExpandNum = 6;
        this.ipFilTitleText = 'Blue Signal Count';
        this.titleFgFlag1 = false;
        this.globalFlagColl = true;
        this.hideListCardFlag();
        this.pnsDropDwFlag = true;
        this.selectInfoCount = this.filtcount['pnsSignal'];
        this.ysBackEvntPNS();
  ...
  lcpSignalInit() {
    if (this.globalFlagColl === true) {
      ...
      if (this.blErrorChk === true && this.ysErrorChk === true) {
        this.collapseExpandFlag = true;
        this.lpDownFlag = false;
        this.indents = [];
        this.selectTypExpandNum = 7;
        this.ipFilTitleText = 'Blue Signal Count';
        this.titleFgFlag1 = false;
        this.globalFlagColl = true;
        this.hideListCardFlag();
        this.lcpDropDwFlag = true;
        this.selectInfoCount = this.filtcount['lcpSignal'];
        this.ysBackEvntLCP();
  ...
  pexfpSignalInit() {
    if (this.globalFlagColl === true) {
      ...
      if (this.blErrorChk === true && this.ysErrorChk === true) {
        this.collapseExpandFlag = true;
        this.pexfDownFlag = false;
        this.indents = [];
        this.selectTypExpandNum = 8;
        this.ipFilTitleText = 'Blue Signal Count';
        this.titleFgFlag1 = false;
        this.globalFlagColl = true;
        this.hideListCardFlag();
        this.pexfpDropDwFlag = true;
        this.selectInfoCount = this.filtcount['pexfpSignal'];
        this.ysBackEvntPEXFP();
  ...
  fexfpSignalInit() {
    if (this.globalFlagColl === true) {
      ...
      if (this.blErrorChk === true && this.ysErrorChk === true) {
        this.collapseExpandFlag = true;
        this.fexfDownFlag = false;
        this.indents = [];
        this.selectTypExpandNum = 9;
        this.ipFilTitleText = 'Blue Signal Count';
        this.titleFgFlag1 = false;
        this.globalFlagColl = true;
        this.hideListCardFlag();
        this.fexfpDropDwFlag = true;
        this.selectInfoCount = this.filtcount['fexfpSignal'];
        this.ysBackEvntFEXFP();
  ...
  sspSignalInit() {
    if (this.globalFlagColl === true) {
      ...
      if (this.blErrorChk === true && this.ysErrorChk === true) {
        this.collapseExpandFlag = true;
        this.sspDownFlag = false;
        this.indents = [];
        this.selectTypExpandNum = 10;
        this.ipFilTitleText = 'Blue Signal Count';
        this.titleFgFlag1 = false;
        this.globalFlagColl = true;
        this.hideListCardFlag();
        this.sspDropDwFlag = true;
        this.selectInfoCount = this.filtcount['sspSignal'];
        this.ysBackEvntSSP();
  ...
  sapSignalInit() {
    if (this.globalFlagColl === true) {
      ...
      if (this.blErrorChk === true && this.ysErrorChk === true) {
        this.collapseExpandFlag = true;
        this.sapDownFlag = false;
        this.indents = [];
        this.selectTypExpandNum = 11;
        this.ipFilTitleText = 'Blue Signal Count';
        this.titleFgFlag1 = false;
        this.globalFlagColl = true;
        this.hideListCardFlag();
        this.sapDropDwFlag = true;
        this.selectInfoCount = this.filtcount['sapSignal'];
        this.ysBackEvntSAP();
  ...
  /*--------SNF--------- */
  ysEvntSNF() {
    return this.httpcon.get<any>(GlobalConstants.apiyellfiltersnf).pipe(map(Response => {
  ...
  ysBackEvntSNF() {
    return this.httpcon.get<any>(GlobalConstants.apiblufiltersnf)
    .pipe(map(Response => {
        this.indents = Response;
      return this.indents;
    }))
  ...
  /*--------SNF--------- */
  ysEvntAP() {
    return this.httpcon.get<any>(GlobalConstants.apiyellfilteradv).pipe(map(Response => {
  ...
  ysBackEvntAP() {
    return this.httpcon.get<any>(GlobalConstants.apiblufilteradv).pipe(map(Response => {
  ...
  /*--------SNF--------- */
  ysEvntLP() {
    return this.httpcon.get<any>(GlobalConstants.apiYellfilterlc).pipe(map(Response => {
      this.indents = Response;
      return this.indents;
    }))
    .subscribe();
  ...
  ysBackEvntLP() {
    return this.httpcon.get<any>(GlobalConstants.apiBlufilterlc).pipe(map(Response => {
      this.indents = Response;
      return this.indents;
    }))
    .subscribe();
  ...
  /*--------SNF--------- */
  ysEvntBP() {
    return this.httpcon.get<any>(GlobalConstants.apiYellfilterbsh).pipe(map(Response => {
      this.indents = Response;
      return this.indents;
    }))
    .subscribe();
  ...
  ysBackEvntBP() {
    return this.httpcon.get<any>(GlobalConstants.apiBlufilterbsh).pipe(map(Response => {
      this.indents = Response;
      return this.indents;
    }))
    .subscribe();
  ...
  /*--------SNF--------- */
  ysEvntOUT() {
    return this.httpcon.get<any>(GlobalConstants.apiYellfilterout).pipe(map(Response => {
      this.indents = Response;
      return this.indents;
    }))
    .subscribe();
  ...
  ysBackEvntOUT() {
    return this.httpcon.get<any>(GlobalConstants.apiBlufilterout).pipe(map(Response => {
      this.indents = Response;
      return this.indents;
    }))
    .subscribe();
  ...
  /*--------SNF--------- */
  ysEvntPNS() {
    return this.httpcon.get<any>(GlobalConstants.apiYellfilterpns).pipe(map(Response => {
      this.indents = Response;
      return this.indents;
    }))
    .subscribe();
  ...
  ysBackEvntPNS() {
    return this.httpcon.get<any>(GlobalConstants.apiBlufilterpns).pipe(map(Response => {
      this.indents = Response;
      return this.indents;
    }))
    .subscribe();
  ...
  /*--------SNF--------- */
  ysEvntLCP() {
    return this.httpcon.get<any>(GlobalConstants.apiYellfilterlcp).pipe(map(Response => {
      this.indents = Response;
      return this.indents;
    }))
    .subscribe();
  ...
  ysBackEvntLCP() {
    return this.httpcon.get<any>(GlobalConstants.apiBlufilterlcp).pipe(map(Response => {
      this.indents = Response;
      return this.indents;
    }))
    .subscribe();
  ...
  /*--------SNF--------- */
  ysEvntPEXFP() {
    return this.httpcon.get<any>(GlobalConstants.apiYellfilterpxef).pipe(map(Response => {
      this.indents = Response;
      return this.indents;
    }))
    .subscribe();
  ...
  ysBackEvntPEXFP() {
    return this.httpcon.get<any>(GlobalConstants.apiBlufilterpxef).pipe(map(Response => {
      this.indents = Response;
      return this.indents;
    }))
    .subscribe();
  ...
  /*--------SNF--------- */
  ysEvntFEXFP() {
    return this.httpcon.get<any>(GlobalConstants.apiYellfilterfexf).pipe(map(Response => {
      this.indents = Response;
      return this.indents;
    }))
    .subscribe();
  ...
  ysBackEvntFEXFP() {
    return this.httpcon.get<any>(GlobalConstants.apiBlufilterfexf).pipe(map(Response => {
      this.indents = Response;
      return this.indents;
    }))
    .subscribe();
  ...
  /*--------SNF--------- */
  ysEvntSSP() {
    return this.httpcon.get<any>(GlobalConstants.apiYellfilterssp).pipe(map(Response => {
      this.indents = Response;
    }))
    .subscribe();
  }
  ...
  ysBackEvntSSP() {
    return this.httpcon.get<any>(GlobalConstants.apiBlufilterssp).pipe(map(Response => {
      this.indents = Response;
      return this.indents;
    }))
    .subscribe();
  ...
  /*--------SNF--------- */
  ysEvntSAP() {
    return this.httpcon.get<any>(GlobalConstants.apiYellfiltersap).pipe(map(Response => {
      this.indents = Response;
      return this.indents;
    }))
    .subscribe();
  ...
  ysBackEvntSAP() {
    return this.httpcon.get<any>(GlobalConstants.apiBlufiltersap).pipe(map(Response => {
      this.indents = Response;
      return this.indents;
    }))
    .subscribe();
  ...
  getBlueSignalData() {
    switch (this.selectTypExpandNum) {
  ...
  getYellowSignalData() {
    switch (this.selectTypExpandNum) {
      ...
      case 1: {
        this.ipFilTitleText = 'Yellow Signal Count';
        this.selectInfoCount = this.filtYellocount['snfSignal'];
        this.indents = [];
        this.ysEvntSNF();
        break;
      }
      case 2: {
        this.ipFilTitleText = 'Yellow Signal Count';
        this.selectInfoCount = this.filtYellocount['apSignal'];
        this.indents = [];
        this.ysEvntAP();
        break;
      }
      case 3: {
        this.ipFilTitleText = 'Yellow Signal Count';
        this.selectInfoCount = this.filtYellocount['lcSignal'];
        this.indents = [];
        this.ysEvntLP();
        break;
      }
      case 4: {
        this.ipFilTitleText = 'Yellow Signal Count';
        this.selectInfoCount = this.filtYellocount['bpSignal'];
        this.indents = [];
        this.ysEvntBP();
        break;
      }
      case 5: {
        this.ipFilTitleText = 'Yellow Signal Count';
        this.selectInfoCount = this.filtYellocount['outSignal'];
        this.indents = [];
        this.ysEvntOUT();
        break;
      }
      case 6: {
        this.ipFilTitleText = 'Yellow Signal Count';
        this.selectInfoCount = this.filtYellocount['pnsSignal'];
        this.indents = [];
        this.ysEvntPNS();
        break;
      }
      case 7: {
        this.ipFilTitleText = 'Yellow Signal Count';
        this.selectInfoCount = this.filtYellocount['lcpSignal'];
        this.indents = [];
        this.ysEvntLCP();
        break;
      }
      case 8: {
        this.ipFilTitleText = 'Yellow Signal Count';
        this.selectInfoCount = this.filtYellocount['pexfpSignal'];
        this.indents = [];
        this.ysEvntPEXFP();
        break;
      }
      case 9: {
        this.ipFilTitleText = 'Yellow Signal Count';
        this.selectInfoCount = this.filtYellocount['fexfpSignal'];
        this.indents = [];
        this.ysEvntFEXFP();
        break;
      }
      case 10: {
        this.ipFilTitleText = 'Yellow Signal Count';
        this.selectInfoCount = this.filtYellocount['sspSignal'];
        this.indents = [];
        this.ysEvntSSP();
        break;
      }
      case 11: {
        this.ipFilTitleText = 'Yellow Signal Count';
        this.selectInfoCount = this.filtYellocount['sapSignal'];
        this.indents = [];
        this.ysEvntSAP();
        break;
      }
